      ...
      <div className="bg-white shadow-xl rounded-lg p-8 md:p-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-800 mb-4">
            مكتبات دار اللغات: شغف المعرفة، وبناء المستقبل
          </h1>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            في قلب كل عائلة وطالب ومعلم، بذرة شغف للاكتشاف والنمو. نحن في "مكتبات دار اللغات" نؤمن بأن الكلمات هي الماء الذي يروي هذه البذرة. لسنا مجرد مكتبة، بل شركاء لكم في رحلة بناء العقول وصناعة المستقبل.
          </p>
        </div>
        ...
        <div className="border-t border-gray-200 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">من كتب تأسيس المهارات وقصص تنمية الخيال، إلى ألعاب "من يستوري" المبتكرة، نحتضن عقل طفلك ونطلق العنان لإبداعه.</p>
            </div>
            {/* Feature 2 */}
