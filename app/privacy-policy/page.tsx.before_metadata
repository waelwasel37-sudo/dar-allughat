        ...
        <div className="bg-white shadow-md rounded-lg p-6 md:p-10 w-full max-w-4xl mx-auto my-8">
            ...
            <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                    نحن في مكتبة دار اللغات نقوم بجمع المعلومات اللازمة لتقديم خدماتنا وتحسينها. تشمل هذه المعلومات اسمك، عنوانك، رقم هاتفك، وعنوان بريدك الإلكتروني عند قيامك بإنشاء حساب أو تقديم طلب.
                </p>
            </section>
